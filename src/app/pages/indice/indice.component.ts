...
export class IndiceComponent implements OnInit {
  ...
  navItems: any[] = [
    ...
    { id: 'controls', text: 'Controles', parentId: '', routeLink: '' },
    ...
    },
    {
      ...
      text: 'Calendar range',
      parentId: 'commons',
      routeLink: 'calendarrange',
    },
    { id: 'chip', text: 'Chip', parentId: 'commons', routeLink: '' },
    { id: 'grid', text: 'Grid', parentId: 'commons', routeLink: 'grid' },
    {
      id: 'containers',
      text: 'Containers',
      parentId: 'controls',
    ...
    { id: 'input', text: 'Input', parentId: 'inputs', routeLink: 'input' },
    {
      ...
      text: 'Input count',
      parentId: 'inputs',
      routeLink: 'inputcount',
    },
    {
      id: 'inputnumber',
      text: 'Input number',
      parentId: 'inputs',
      routeLink: 'inputnumber',
    },
    {
      id: 'inputslider',
      text: 'Input slider',
      parentId: 'inputs',
      routeLink: 'inputslider',
    },
